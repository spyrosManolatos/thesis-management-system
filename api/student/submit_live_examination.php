...
<?php
session_start();
$date = $_POST['live_exam_date'];
$time = $_POST['live_exam_time'];
$location = $_POST['live_exam_location'];
...
try{
    ...
    if($result >= 1){
        ...
        $query = $connect ->prepare("INSERT INTO student_presentation (meeting_hour,meeting_room_or_link,physical_presense,thesis_assignment_id) VALUES(:time,:location,1,:assignment_id)");
